...
$listarinsumo = json_decode($ControladorInusmo->ListarInsumo());
...
<body>
    ...
    <div class="hero-container">        
        <h2 class="insumo"><u>Listado de insumos.</u></h2>
        <div class="card-body" >
        
            <table border="1" class="table table-sriped  table-bordered" id="litarroles">
              <a href="Reportes.Insumos.php" target="_blank" class="btn" style="background:#D8F6DF; border-radius: 8px;color:black; margin-right: 900px">Generar reporte
              <svg xmlns="http://www.w3.org/2000/svg" class="verdll"width="22" height="22" fill="currentColor" class="fa bi bi-file-earmark-pdf " viewBox="0 0 16 16">
                  ...
                  <?php
                  foreach($listarinsumo as $producto)
                  {
                  ?> 
                  <tr>
                      <!--<td><?php echo $producto->IdInsumo?></td>-->
                      ...
                      <td>
                          <a href="../Controlador/ControladorInsumo.php?EditarInsumo&Idinsumo=<?php echo $producto->IdInsumo?>" class="btn" style="background:#DD93FF; color:black;" >Editar</a>
                      </td>
                      <td>
                          <a href="../Controlador/ControladorInsumo.php?CambiarEstadoInsu&Idinsumo=<?php echo $producto->IdInsumo?>" class="btn" style="background:#FFCACA; color:black;" ><?php if($producto->Estado == 1 ){
                          echo "Inhabilitar";
                      } else
                      {
                          echo "Activar";
