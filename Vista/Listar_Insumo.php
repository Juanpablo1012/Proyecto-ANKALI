    ...
    <div class="hero-container">        
        ...
        <div class="card-body" >
            ...
            <table border="1" class="table table-sriped  table-bordered" id="litarroles">
              <a href="Reportes.Insumos.php" class="btn" style="background:#D8F6DF; border-radius: 8px;color:black; margin-right: 900px">Generar reporte
              <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="fa bi bi-file-earmark-pdf " viewBox="0 0 16 16">
