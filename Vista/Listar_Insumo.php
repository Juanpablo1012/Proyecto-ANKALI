...
<body>
    ...
    <nav id="nav-menu-container">
      ...
      <section id="hero4" class="wow fadeIn">
        ...
        <div class="card-body" >
        <h2 class="insumo">Listado de insumos ingresados.</h2>
            <table border="1" class="table table-sriped  table-bordered" id="litarroles">
                ...
                <tr>
                    ...
                    <?php  $ruta= $producto->Imagen;?>
				              <td><?php echo "<img src='$ruta' widht='130' height='100' />"  ?></td> 
                      <td>
                    ...
                    <td>
                        <a href="../Controlador/ControladorInsumo.php?EditarInsumo&Idinsumo=<?php echo $producto->IdInsumo?>" class="btn btn" >Editar</a>
                    </td>
                    <td>
                        <a href="../Controlador/ControladorInsumo.php?CambiarEstadoInsu&Idinsumo=<?php echo $producto->IdInsumo?>" class="btn btn" ><?php if($producto->Estado == 1 ){
                        echo "Inhabilitar";
                    } else
                    {
                        echo "Activar";
