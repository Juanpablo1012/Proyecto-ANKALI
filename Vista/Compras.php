    ...
    <div class="wrapper2 fadeInDown">
        <div id="formContent3">
          ...
          <form action="../Controlador/ControladorCompras.php" method="Post" enctype="multipart/form-data">
            ...
            <input type="file" id="Factura" class="fadeIn third imagen" name="Factura" placeholder="Factura" ><br>
            <label for=""><b>Total de la factura:</b></label>
            <input type="number" id="Total" class="fadeIn second total" name="Total" placeholder="Total de la compra" ><br>
