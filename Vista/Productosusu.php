        ...
        ?> 
          <div class="col-md-5 col-lg-3">
            <div class="feature-block">
              ...
              <!-- <a href="javascript:void(0)" onclick="MostrarInsumo('<?php echo $producto->IdProducto?>')"> ver insumos </a> -->
              <a class="btn" style="background:#DEEDFF;color:#000;" href="../Controlador/ControladorProductos.php?Verproducto&Idproducto=<?php echo $producto->IdProducto?>"><i class="fa fa-eye fa-3 verdll" style="font-size: 15px; "></i> Ver insumos</a>
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header">
              <h3 class="modal-title" id="staticBackdropLabel" style="  text-align: left;font-size: 25px;">Insumos de </h3>
