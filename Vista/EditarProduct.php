    ...
    <div class="wrapper2 fadeInDown">
        <div id="formContent3">
          ...
          <form action="../Controlador/ControladorProductos.php" method="Post" enctype="multipart/form-data">
            ...
            <input type="hidden" name="IdProducto" class="fadeIn third" value="<?php echo $product->getIdProducto() ?>" placeholder="Codigo producto">
            ...
            <button type="submit" ID="EditarProducto"name="EditarProducto" class="fadeIn fourth">Editar</button>
          </form>
