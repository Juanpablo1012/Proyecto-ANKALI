    ...
    <div class="wrapper4 fadeInDown">
      <div id="formContent4">
        ...
        <form name="frmpedido" id="frmpedido" method="post">
          ...
          <label for="" > <b>Nombre del<br> insumo: </b></label>
          ...
          <div class="form-group">
          <label for=""> <b>Valor del<br> insumo:</b> </label>
          ...
          <input type="number" id="Cantidad" class="fadeIn second pedidou" name="Cantidad" placeholder="Cantidad">
          </div>

          <div class="form-group">
          <label for=""><b>Valor total:</i></label>
          <input type="number" id="Total" class="fadeIn second total" name="Total" readonly placeholder="Valor total">
          </div>
...
<br>
      ...
      <script>
        //cambiar tamaño c:
        let cambiar = document.querySelector(".pedidoP").style.width="80%";
        let cambiar1 = document.querySelector(".pedidoV").style.width="80%";
        let cambiar2 = document.querySelector(".pedidou").style.width="80%";
        let cambiar3 = document.querySelector(".total").style.width="80%";
