...
<body>
    ...
    <div class="container mt-4">
      <h2 class="insumo">Listado de pedidos.</h2>
        <div class="card-body" >
            <table border="1" class="table table-sriped  table-bordered" id="litarroles">
                ...
                <tr class="centrar">
                    ...
                    <td class="centrar">
                    <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-pdf" viewBox="0 0 16 16">
