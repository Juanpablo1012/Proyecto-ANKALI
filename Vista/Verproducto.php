...
<body>
    ...
    <div style="margin-left: 300px;" class="container mt-4">
    <?php
                      foreach($Listardetalle as $producto)
                      {
                     ...
                     <h3> <?php echo 'Producto:  '.$Nombre?></h3> <br>
                      <?php echo "<img src='$ruta' widht='300' height='300' style='float: left;' />"?>
            <div class="hero-container">  

        
        <div class="card-body" style="margin-left: 650px;" >  
        <br><br><h3>Insumos del producto</h3> <br>
        ...
        <?php
                      ...
                      {
                        ?>
                       <p style="text-align: left;"> <?php echo $producto['NombreI'].'<b> Cantidad: </b>'. $producto['Total']?></p>
                       <?php
                      }
                      ?>

                    <br><br> <h3 style="text-align: left;">Precio: <?php echo $Precio; ?></h3> <br><br> 
