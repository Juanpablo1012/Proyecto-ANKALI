    ...
    <div class="container mt-4">
      ...
      <h2 class="centrar"><u>Listado de ventas.</u></h2>
        <div class="card-body" >
            ...
            <a href="Reportes.Pedido.php" class="btn"style="background:#D8F6DF; border-radius: 8px;color:black;">Generar reporte<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="fa bi bi-file-earmark-pdf " viewBox="0 0 16 16">
