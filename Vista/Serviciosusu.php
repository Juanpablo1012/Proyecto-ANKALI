...
$listarproducto = json_decode($ControladorProductos->Listarserviciosusu());
session_start();
...
<body>
  ...
  <section id="productos" class="padd-section text-center wow fadeInUp">
    ...
    <div class="container">
      <div class="">
        <h2 class="centrar izq"><u>Servicios</u></h2>
      </div>
    </div>
  ...
  <script>
    function alerta(){
            ...
            Swal.fire({
              icon: 'warning',
              html: '<h3 style="color:black;font-size: 25px;text-align: center;">Para personalizar un servicio, debes de hacerlo con 3 días de anticipación.</h3><br><h3 style="color:black;font-size: 15px;text-align: center;">Haz click en el botón "Personalizar para ponerte en contacto con nosotros"</h>',
