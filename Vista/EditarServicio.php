    ...
    <div class="wrapper2 fadeInDown">
        <div id="formContent3">
          ...
          <form action="../Controlador/ControladorProductos.php" method="Post" enctype="multipart/form-data">
            ...
            <label for=""><b>Imagen del<br> servicio:</b></label>
            <input type="file" name="Imagen" class="fadeIn second imagen" value="<?php echo $product->getImagen() ?>" placeholder="Imagen" ><br>   

            <button type="submit" ID="EditarProducto"name="EditarServicio" class="fadeIn fourth">Editar</button>
          </form>
