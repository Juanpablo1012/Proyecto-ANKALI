...
<section id="hero4" class="wow fadeIn">
    ...
    <div class="container mt-4">
        <h2 class="centrar insumo"><u>Listado de servicios.</u></h2>
        
        <div class="card-body" >
            <table border="1" class="table table-sriped  table-bordered centrar" id="listarserv">
                <a href="Reportes.Servicios.php" class="btn"style="background:#D8F6DF; border-radius: 8px;color:black;">Generar reporte<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="fa bi bi-file-earmark-pdf " viewBox="0 0 16 16">
              ...
              <tr>
                    ...
                    <td>
                        <a href="../Controlador/ControladorProductos.php?EditarServicio&IdProducto=<?php echo $servicio->IdProducto?>" class="btn"style="background:#DD93FF; color:black;" >Editar</a>
                    </td>
                    <td>
                        <a href="../Controlador/ControladorProductos.php?CambiarEstadoS&IdProducto=<?php echo $servicio->IdProducto?>" class="btn" style="background:#FFCACA; color:black;" ><?php if($servicio->Estado == 1 ){
                        echo "Inhabilitar";
                    } else
                    {
                        echo "Activar";
