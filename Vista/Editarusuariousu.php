...
<body>
    ...
    <div class="wrapper2 fadeInDown">
      <div id="formContent2">
        ...
        <div class="fadeIn first">
          <h6>Información del usuario</h6><br>
        </div>
        <!-- Login Form -->
        <form method="POST" action="../Controlador/ControladorUsuarios.php">

          <label for=""><b>Documento </b></label>
          <input type="number" id="Documento" class="fadeIn third documento" name="Documento" value="<?php echo $doc->getDocumento() ?>" placeholder="Número de documento"><br>

          <label for=""><b>Teléfono</b></label>
          <input type="number" id="Telefono" class="fadeIn second telefono" name="Telefono"  value="<?php echo $doc->getTelefono() ?>" placeholder="Número de télefono"><br>
          
          <label for=""><b>Nombre</b></label>
          <input type="text" id="Nombre" class="fadeIn third nombre" name="Nombre" value="<?php echo $doc->getNombre() ?>"  placeholder="Nombre"><br>
          
          <label for=""><b>Correo</b></label>

          <input type="email" id="Correo" class="fadeIn second correo" name="Correo" value="<?php echo $doc->getCorreo() ?>" placeholder="Correo" ><br>
          
          <label for=""><b>Dirección</b></label>
          <input type="text" id="Direccion" class="fadeIn second direccion" name="Direccion" value="<?php echo $doc->getDireccion() ?>"  placeholder="Dirección"><br>
          <label for=""><b>Contraseña</b> </label>
          <input type="text" id="Contrasena" class="fadeIn third contrasena" name="Contrasena" value="<?php echo $doc->getContrasena() ?>" placeholder="Contraseña">
  ...
  <script>
        ...
        let cambiar3 = document.querySelector(".correo").style.width="70%";
        let cambiar4 = document.querySelector(".correo").style.width="70%";
        let cambiar5 = document.querySelector(".direccion").style.width="70%";
        let cambiar6 = document.querySelector(".contrasena").style.width="70%";
