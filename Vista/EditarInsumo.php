    ...
    <div class="wrapper2 fadeInDown">
        <div id="formContent3">
          ...
          <form action="../Controlador/ControladorInsumo.php" method="Post" enctype="multipart/form-data">
            ...
            <input type="hidden" name="IdInsumo" class="fadeIn third" value="<?php echo $insumo->getIdInsumo() ?>" placeholder="Codigo producto" readonly>
            <label for=""><b>Nombre</b></label>
            <input type="text" name="Nombre" class="fadeIn third nombre" value="<?php echo $insumo->getNombre() ?>" placeholder="Nombre"><br>
