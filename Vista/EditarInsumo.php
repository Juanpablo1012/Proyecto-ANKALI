    ...
    <div class="wrapper2 fadeInDown">
        <div id="formContent3">
          ...
          <form action="../Controlador/ControladorInsumo.php" method="Post" enctype="multipart/form-data">
            ...
            <input type="hidden" name="IdInsumo" class="fadeIn third" value="<?php echo $insumo->getIdInsumo() ?>" placeholder="Codigo producto" >
            <label for=""><b>Nombre:</b></label>

            <input type="text" name="Nombre" class="fadeIn third nombre" value="<?php echo $insumo->getNombre() ?>" placeholder="Nombre" >
            <br><label for=""><b>Precio:</b></label>

            <input type="number" name="Precio" class="fadeIn second precio" value="<?php echo $insumo->getPrecio() ?>" placeholder="Precio" >

            <br><label for=""><b>Imagen del<br> insumo:</b></label>

            <input type="file" name="Imagen" class="fadeIn second imagen" value="<?php echo $insumo->getImagen() ?>" placeholder="Imagen" >

            <br><label for=""><b>Cantidad:</b></label>

            <input type="number" name="Stock" class="fadeIn second cantidad"  value="<?php echo $insumo->getStock() ?>" placeholder="Cantidad" >
             
            
<br>
            <button type="submit" ID="EditarInsumos" name="EditarInsumos" class="fadeIn fourth">Guardar</button>
          </form>
