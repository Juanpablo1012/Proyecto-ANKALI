...
$listarproducto = json_decode($ControladorProductos->Listarproducto());
    ...
    <nav id="nav-menu-container">
      ...
      <div class="container mt-4">
        ...
        <table border="1" class="table table-sriped  table-bordered centrar" id="litarroles">
              <a href="Reportes.Productos.php" target="_blank" class="btn"style="background:#D8F6DF; border-radius: 8px;color:black;">Generar reporte<svg xmlns="http://www.w3.org/2000/svg" class="verdll"width="22" height="22" fill="currentColor" class="fa bi bi-file-earmark-pdf " viewBox="0 0 16 16">
